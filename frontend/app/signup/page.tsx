      ...
      <div className="min-h-screen bg-grid flex items-center justify-center px-4">
        <div className="relative z-10 w-full max-w-md text-center">
          <div className="glass-card rounded-2xl p-10">
            <div className="mb-4 mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-success/15">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg>
            </div>
            <h2 className="mb-2 text-xl font-bold text-text">Check your email</h2>
            <p className="text-text-sub text-sm">
              We sent a confirmation link to <span className="text-text font-medium">{email}</span>.
              Click it to activate your account.
            </p>
            <Link href="/login" className="mt-6 inline-block text-sm text-accent hover:text-accent/80 transition-colors">
              Back to sign in
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-grid flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-text-sub text-sm">Create your account</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            <div>
              <label className="mb-1.5 block text-xs font-medium text-text-sub" htmlFor="signup-name">
                Name <span className="text-text-sub/50">(optional)</span>
              </label>
              <input
                id="signup-name"
                type="text"
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium text-text-sub" htmlFor="signup-email">
                Email
              </label>
              <input
                id="signup-email"
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium text-text-sub" htmlFor="signup-password">
                Password
              </label>
              <input
                id="signup-password"
